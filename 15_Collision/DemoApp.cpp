...
void DemoApp::Update()
{
	...
	if (ImGuiMenu::SkinningTestFBX)
	{
		...
		testObjectInfo.m_ObjectInfo.m_Name = "Skinning";
		testObjectInfo.m_ObjectInfo.m_Position = Vector3(rand() % 4000 - 2000, rand() % 4000 - 2000, rand() % 4000 - 2000);
	...
	else if (ImGuiMenu::ZeldaFBX)
	{
		...
		testObjectInfo.m_ObjectInfo.m_Name = "Skinning";
		testObjectInfo.m_ObjectInfo.m_Position = Vector3(rand() % 4000 - 2000, rand() % 4000 - 2000, rand() % 4000 - 2000);
		testObjectInfo.m_RenderName = "ZeldaRenderComponent";
		testObjectInfo.m_RenderPath = "../Resource/Texture/zeldaPosed001.fbx";
		object->Setting(testObjectInfo);
		object->Init();
